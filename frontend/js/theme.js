...
(function () {
    ...
    var AURORA_CSS = [
        ...
        '  --table-head-column-odd-tint: rgba(255,255,255,0.025);',
        '  --table-head-column-even-tint: rgba(167,139,250,0.13);',
        '  --table-column-odd-tint: rgba(255,255,255,0.01);',
        '  --table-column-even-tint: rgba(167,139,250,0.075);',
        '  --table-column-hover-odd-tint: rgba(167,139,250,0.1);',
        '  --table-column-hover-even-tint: rgba(167,139,250,0.16);',
        '}',
        /* body / main 背景 */
    ...
    var GLOW_DIGITAL_CSS = [
        ...
        '  --table-head-column-odd-tint: rgba(15,23,42,0.015);',
        '  --table-head-column-even-tint: rgba(99,102,241,0.07);',
        '  --table-column-odd-tint: rgba(255,255,255,0.04);',
        '  --table-column-even-tint: rgba(99,102,241,0.045);',
        '  --table-column-hover-odd-tint: rgba(99,102,241,0.07);',
        '  --table-column-hover-even-tint: rgba(56,189,248,0.1);',
        '}',
        /* 光晕动画背景层 */
    ...
    var GLOW_DIGITAL_DARK_CSS = [
        ...
        '  --table-head-column-odd-tint: rgba(255,255,255,0.025);',
        '  --table-head-column-even-tint: rgba(129,140,248,0.14);',
        '  --table-column-odd-tint: rgba(255,255,255,0.012);',
        '  --table-column-even-tint: rgba(129,140,248,0.08);',
        '  --table-column-hover-odd-tint: rgba(129,140,248,0.12);',
        '  --table-column-hover-even-tint: rgba(56,189,248,0.14);',
        '}',
        /* 蓝色光晕（左上角，body::after） */
